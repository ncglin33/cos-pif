...
class PifNav extends HTMLElement {
  ...
  render() {
    ...
    const pifLinks = [
        { text: 'PIF - 封面', href: 'pif01-1.html' },
        { text: 'PIF - 目錄', href: 'pif01-2.html' },
        { text: 'PIF 01 - 產品基本資料', href: 'pif01-3.html' },
        ...
        { text: 'PIF16pro - 進階產品安全', href: 'pif16pro.html' },
        { text: 'PIF16SA - 安全評估結論', href: 'pif16sa.html' }
    ];
